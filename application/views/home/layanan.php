                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div class="our-services-box">
                            <div class="our-services-items">
                                <img src="<?php echo base_url('assets/upload/image/'.$layanan->gambar) ?>" alt=""
                                    style="width: 500px;height: 200px;">
                                <i class="<?php echo $layanan->icon ?> fa-5x"
                                    style="color:#337ab7; margin-bottom: 20px;"></i>
                                <div class="our-services-content">
                                    ...
                                    <a href="<?php echo base_url('berita/layanan/'.$layanan->slug_berita) ?>">read
