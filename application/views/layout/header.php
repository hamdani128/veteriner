...
<div class="header-top">
    <ul class="h-contact">
        <li><i class="#"></i> <?php echo $site->namaweb ?></li>
    </ul>
    <div class="donate-option">
        ...
        <?php }else{ ?>
            <a href="https://wa.me/<?php echo str_replace('+','',$site->hp) ?>?text=Saya%20tertarik%20untuk%20Menggunakan%20Layanan%20di%20PT.%20AZANDI%20SUKSES%20PRATAMA.%20Apakah%20bisa%20dibantu?"><i class="fa fa-whatsapp" aria-hidden="true"></i><?php echo $site->hp ?></a>
