...
<div class="bg-main-menu menu-scroll">
    <div class="container">
        <div class="row">
            ...
            <div class="main-menu">
                <a class="show-res-logo" href="<?php echo base_url() ?>" style="float:left"><img src="<?php echo $this->website->logo() ?>" alt="logo" class="img-responsive" style="max-height: 60px; width: auto;" /></a>
                ...
                <nav class="navbar">
                    ...
                    <div class="row col-lg-5 row-no-gutters text-center" style="margin-top:10px;margin-bottom:10px">
                                <a class="navbar-brand hidden-xs hidden-sm" href="<?php echo base_url() ?>"><img src="<?php echo $this->website->logo() ?>" alt="logo" class="img-responsive" style="max-height: 60px; width: auto;" /></a>
                                <a class="navbar-brand hidden-lg hidden-md" href="<?php echo base_url() ?>"><img src="<?php echo $this->website->logo() ?>" alt="logo" class="img-responsive" style="max-height: 80px; width: auto;margin-top:10px" /></a>
                           
                            <div style="font-size: 18px; font-weight:bold" class="col-lg-8 col-sm-8 col-xs-8">KEMENTRIAN PERTANIAN</div>
                            <div style="font-size: 12px; font-weight:bold;word-wrap: break-word;" class="col-lg-8 col-sm-8 col-xs-8"> DIREKTORAT JENDRAL PERTERNAKAN DAN KESEHATAN HEWAN BALAI VETERINER MEDAN</div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <!-- DOWNLOAD -->
                            <li><a href="<?php echo base_url('download') ?>">PUBLIKASI</a></li>
