                    ...
                    <div class="col-md-8">
                        ...
                        <div class="blog-items">
                            ...
                            <div class="blog-img" style="width:770px;height:370px;">
                                <a href="#"><img src="<?php echo base_url('assets/upload/image/' . $berita->gambar) ?>"
                                    ...
                                    <ul class="popular-news-option">
                                        ...
                                        <li>
                                            ...
                                            <div class="popular-news-contant">
                                                <h5><a
                                                        href="<?php echo base_url('berita/read/' . $listing->slug_berita); ?>"><?php echo $listing->judul_berita; ?></a>
                                                </h5>
                                                <p><?php echo date('d M Y', strtotime($listing->tanggal_publish)); ?>
                                                </p>
                                            </div>
                                            <!-- .popular-news-img -->
                                        </li>
