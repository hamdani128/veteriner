                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="#" class="btn btn-danger btn-xs" onclick="DeleteBerita('<?php echo $berita->id_berita ?>')"><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
...
<script>
    function DeleteBerita(id) {
        Swal.fire({
            ...
            text: "Data Berita " + id + " Akan dihapus !",
            icon: 'warning',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo base_url('admin/berita/delete') ?>",
                    method: "POST",
                    data: {
                        id: id
                    },
