            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="tanggal_publish" class="form-control tanggal"
                        ...
                        value="<?php if(isset($_POST['tanggal_publish'])) { echo set_value('tanggal_publish'); }else{ echo date('Y-m-d',strtotime($berita->tanggal_publish)); } ?>"
                        data-date-format="dd-mm-yyyy">
                </div>
                <div class="col-md-6">
                    <label>Jam Publish</label>
                    <input type="text" name="jam_publish" class="form-control time-picker" placeholder="Jam publikasi"
                        value="<?php if(isset($_POST['jam_publish'])) { echo set_value('jam_publish'); }else{ echo date('H:i:s',strtotime($berita->tanggal_publish)); } ?>">
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group form-group-lg">
            ...
            <select name="status_berita" class="form-control">
                ...
                <option value="Draft" <?php if($berita->status_berita=="Draft") { echo "selected"; } ?>>Simpan sebagai
                    draft</option>
            </select>
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
            ...
            <select name="jenis_berita" class="form-control">
                ...
                <option value="Layanan" <?php if($berita->jenis_berita=="Layanan") { echo "selected"; } ?>>Layanan
                </option>
            </select>
        ...
        <div class="form-group">
            <!-- <label>Isi berita <sup>
                    <a data-toggle="modal" class="btn btn-info btn-xs"
                        href="<?php echo base_url('admin/berita/files') ?>" data-target="#file"><i
                            class="fa fa-download"></i> Attach File</a>

                    <a data-toggle="modal" class="btn btn-info btn-xs"
                        href="<?php echo base_url('admin/berita/gambar') ?>" data-target="#gambar"><i
                            class="fa fa-download"></i> Attach Gambar</a>

                </sup>
            </label> -->
            <textarea name="isi" class="form-control" id="isi" placeholder="Isi berita"
