    ...
    <div class="col-md-8">
        ...
        <div class="form-group form-group-lg">
            ...
            <input type="text" name="judul_berita" class="form-control" placeholder="Judul berita/profil/layanan"
                required="required" value="<?php echo set_value('judul_berita') ?>">
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="jam_publish" class="form-control time-picker" placeholder="Jam publikasi"
                        value="<?php if (isset($_POST['jam_publish'])) {
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <textarea name="keywords" class="form-control"
                placeholder="Keywords (untuk pencarian Google)"><?php echo set_value('keywords') ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="isi" class="form-control" id="isi"
                placeholder="Isi berita"><?php echo set_value('isi') ?></textarea>
        </div>
