        ...
        <tbody>
            ...
            <tr class="odd gradeX">
                    ...
                    <div class="mailbox-star text-center">
                        <div class="text-center">
                            <input type="checkbox" class="icheckbox_flat-blue " name="id_video[]"
                                value="<?php echo $video->id_video ?>">
                            <span class="checkmark"></span>
                        </div>
                </td>
                <td class="video"> <iframe src="https://www.youtube.com/embed/<?php echo $video->video ?>"></iframe>
                </td>
                <td>
                    <?php echo $video->judul ?> - <?php echo $video->urutan ?>
                    <sup><a href="<?php echo base_url('video/detail/'.$video->id_video) ?>"><i
                                class="fa fa-link"></i></a></sup>
                    <br><small>Lang: <span
                            class="flag-icon <?php if($video->bahasa=="English") { echo "flag-icon-gb"; }else{ echo "flag-icon-id"; } ?>"></span>
                        <?php echo $video->bahasa ?></small>
                </td>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        <a href="<?php echo base_url('admin/video/edit/'.$video->id_video) ?>"
                            class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>


                        <a href="<?php echo base_url('admin/video/delete/'.$video->id_video) ?>"
